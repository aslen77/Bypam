...
<?php include("vues/menu_personnaliser.php"); ?>
...
<?php //include("vues/board.php"); ?>       
			...
			if(isset($_GET['p']))
			{
				...
				if($_GET['p']=="ajouter_menu")include("vues/ajouter_menu.php");
				if($_GET['p']=="consulter_menu")include("vues/consulter_menu.php");
				
				if($_GET['p']=="ajouter_page")include("vues/ajouter_page.php");
				if($_GET['p']=="consulter_page")include("vues/consulter_page.php");
				
			}
			else
				include("vues/visualiser_template.php");
			?>
