...
$(function() {
   ...
   series.columns.template.fill = am4core.color("#e52d27");
   series.columns.template.stroke = am4core.color("#e52d27");
   ...
   series2.columns.template.fill = am4core.color("#3949AB");
   series2.columns.template.stroke = am4core.color("#3949AB");
   ...
   series3.columns.template.fill = am4core.color("#2ca961");
   series3.columns.template.stroke = am4core.color("#2ca961");
...
$(function() {
   ...
   continentsSeries.data = [{
       ...
       "id": "oceania",
       "color": am4core.color("#e52d27")
   }, {
       "id": "europe"
   }, {
       "id": "northAmerica",
       "color": am4core.color("#2ca961"),
   }, {
       "id": "southAmerica"
   }];
...
$(function() {
   ...
   series.columns.template.fill = am4core.color("#3949AB");
   series.columns.template.stroke = am4core.color("#3949AB");
...
$(function() {
   ...
   gradient.addColor(am4core.color("#3949ab"), 1);
   gradient.addColor(am4core.color("#2962ff"), 1);
   gradient.rotation = -45;

   var gradient1 = new am4core.LinearGradient();
   gradient1.addColor(am4core.color("#2ca961"), 1);
...
$(function() {
   ...
   var gradient = new am4core.LinearGradient();
   gradient.addColor(am4core.color("#e52d27"), 0.2);
   gradient.addColor(am4core.color("#e52d27"), 0);
   series.fill = gradient;

   // this makes date axis labels to fade out  f57c00
   ...
   bullet.fill = am4core.color("#e52d27");
...
$(function() {
   ...
   series.strokeWidth = 2;
   series.tooltipText = "{valueY.value}";
   series.fill = am4core.color("#f57c00");
   series.stroke = am4core.color("#f57c00");
   chart.padding(0, 0, 0, 0);
});
// [ real4-chart ] end
...
$(function() {
   ...
   series.fillOpacity  = 1;
   var gradient = new am4core.LinearGradient();
   gradient.addColor(am4core.color("#2ca961"), 0.2);
   gradient.addColor(am4core.color("#2ca961"), 0);
   gradient.rotation = 90;
   series.fill = gradient;
   series.tooltip.getFillFromObject = false;
   series.tooltip.background.fill = am4core.color("#2ca961");
...
$(function() {
   ...
   series.fill = gradient;
   series.tooltip.getFillFromObject = false;
   series.tooltip.background.fill = am4core.color("#e52d27");
...
$(function() {
   ...
   series.fillOpacity  = 1;
   var gradient = new am4core.LinearGradient();
   gradient.addColor(am4core.color("#f57c00"), 0.2);
   gradient.addColor(am4core.color("#f57c00"), 0);
   gradient.rotation = 90;
   series.fill = gradient;
   series.tooltip.getFillFromObject = false;
   series.tooltip.background.fill = am4core.color("#f57c00");
...
$(function() {
   ...
   series2.stroke = am4core.color("#463699");
   series2.fill = am4core.color("#463699");
   ...
   series3.stroke = am4core.color("#2ca961");
   series3.fill = am4core.color("#2ca961");
