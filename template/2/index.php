    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
				...
				<img src="../../images/users/<?php echo $u->photo; ?>" width="30" ><span class="m-l-10"><?php echo $u->prenom."&nbsp;".$u->nom; ?></span></a>
            </div>
        </li>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="../../img/users/<?php echo $u->photo; ?>" alt="">
                                    <div class="media-body">
                                        <span class="name"><?php $u->nom."&nbsp;".$u->prenom ?></span>
                                    </div>
                                </div>
                            </a>
                        </li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href="profile.html"><img src="../../images/logos/<?php echo $app->logo; ?>" alt="User"></a></div>
                            <div class="detail">
                                <h4><?php echo $app->nom; ?></h4>
                            </div>
                        </div>
                    </li>
                ...
                <ul class="list">
                    <li>
                        <div class="user-info m-b-20 p-b-15">
							...
							<img src="../../images/users/<?php echo $u->photo ?>" alt="User"></a></div>
                            <div class="detail">
                                <h4><?php echo $u->prenom.'&nbsp'.$u->nom; ?></h4>
                            </div>
                            <div class="row">
                                <div class="col-12">
...
<!-- Mirrored from thememakker.com/templates/oreo/hospital/html/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Apr 2019 17:58:26 GMT -->
</html>