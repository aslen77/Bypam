...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 23 avr. 2019 à 14:15
...
(1, 12, 'Ajouter patient', 'ajoutpatient', 1),
(10, 12, 'contact', 'contact', 2),
(4, 13, 'Ajouter produit', 'ajoutproduit', 1),
(5, 13, 'Liste produits', 'listeproduit', 2),
(6, 14, 'Ajouter produit', 'ajoutproduit', 1),
(7, 14, 'Liste produits', 'listeproduit', 3),
(8, 14, 'Statistique', 'stat', 2);
...
CREATE TABLE IF NOT EXISTS `page` (
  ...
  `diriger_vers` varchar(200) NOT NULL,
  `type` varchar(200) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_application` (`id_application`),
  KEY `diriger_vers` (`diriger_vers`)
...
INSERT INTO `page` (`id`, `id_application`, `titre`, `diriger_vers`, `type`) VALUES
(1, 14, 'Ajouter produit Adidas', '6', 'Formulaire');
